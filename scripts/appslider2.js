...
// Get slider area
const sliderArea = document.querySelector('#sliderArea1');

// Get slider items
const sliderItems = Array.from(document.querySelectorAll('.testimonial__slider1 .testimonial__slide1'));

// Get number of slides
const slidesCount = sliderItems.length;

// Get previous and next buttons
const nextButton = document.querySelector('#sliderNextBtn1');
const previousButton = document.querySelector('#sliderPrevBtn1');
